...
import { Building2, LayoutList, Palette, Users, LogOut, Menu, X } from "lucide-react";
...
export default function OrgAdminSidebar({ adminEmail, orgSlug, orgShortName, orgLogoUrl, orgPrimaryColor }: SidebarProps) {
    ...
    <>
      ...
      `}>
        ...
        <div className="p-6 border-t border-surface-200 mt-auto bg-white">
          <div className="text-sm text-surface-600 mb-2 truncate" title={adminEmail}>
            {adminEmail}
          </div>
          <form action={adminLogout}>
            <button type="submit" className="text-xs text-red-500 hover:text-red-400 font-medium flex items-center gap-1">
